...
export const changeProfile = (state: {
  ...
  subinfo: { title: string; content: {image: string; title: string}[] }[];
}) => (dispatch: any) => {
  dispatch({
    type: CHANGEPROFILE,
    payload: state,
...
export const changeNews = (state: {
  ...
  view?: number;
  order?: number;
  content?: {title: string; content: string; datetime: string; reporter: string; img: string;}[];
}) => (dispatch: any) => {
  dispatch({
    type: CHANGENEWS,
    payload: state,
...
export const changeImage = (state: {
  ...
  view?: number;
  order?: number;
  content?: {img1: string; img2: string; img3: string; img4: string;}[];
}) => (dispatch: any) => {
  dispatch({
    type: CHANGEIMAGE,
    payload: state,
